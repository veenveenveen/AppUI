...
#import "CarouselViewController1.h"
...
@interface CarouselViewController1 () <CarouselViewDelegate, UINavigationControllerDelegate, UITableViewDataSource, UITableViewDelegate, LEMCustomNavViewDelegate>

@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) CarouselView *carouselView;
@property (nonatomic, strong) LEMCustomNavView *customNavBar;

@property (nonatomic, strong) NSArray<CarouselColorModel *> *models;

@property (nonatomic, strong) CAShapeLayer *topLayer;

@end

@implementation CarouselViewController1
...
- (void)setupViews {
    ...
    CarouselColorModel *startModel = self.models[_carouselView.currentPage];
...
// 根据不同的page改变背景色
- (void)changeColorWith:(CarouselColorModel *)model {
...
- (void)navigationController:(UINavigationController *)navigationController willShowViewController:(UIViewController *)viewController animated:(BOOL)animated {
    BOOL isHideNav = ([viewController isKindOfClass:[CarouselViewController1 class]]);
...
- (void)carouselView:(CarouselView *)carouselView didScrollToIndex:(NSInteger)index data:(nonnull CarouselColorModel *)model {
...
- (CarouselView *)carouselView {
    if (!_carouselView) {
        ...
        _carouselView = [[CarouselView alloc] initWithFrame:CGRectMake(15, 0, UIScreen.mainScreen.bounds.size.width-30, pCarouseHeight) models:self.models];
...
- (NSArray<CarouselColorModel *> *)models {
    return [CarouselColorModel createModels];
}
...
- (CAShapeLayer *)topLayer {
    if (!_topLayer) {
        ...
        [path addQuadCurveToPoint:CGPointMake(viewWidth, 40) controlPoint:CGPointMake(viewWidth*0.5, 150)];
