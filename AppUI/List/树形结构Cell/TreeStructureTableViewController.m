...
static NSString *cellID = @"CityModelCell";
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[CityModelCell class] forCellReuseIdentifier:cellID];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    CityModelCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
