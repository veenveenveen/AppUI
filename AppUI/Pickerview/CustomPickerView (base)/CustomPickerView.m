...
@property (nonatomic, readwrite, strong) UIPickerView                *pickView;
@property (nonatomic, readwrite, assign) ECustomPickerViewHeightType  pickerViewHeightType;
...
- (instancetype)initWithFrame:(CGRect)frame
    ...
    CGFloat height             = [self heightWithPickerViewHeightType:pickerViewHeightType];
...
- (void)layoutSubviews {
    ...
    self.pickView.frame  = CGRectMake(0, 0, self.frame.size.width, [self heightWithPickerViewHeightType:self.pickerViewHeightType]);
    self.pickView.center = CGPointMake(self.frame.size.width / 2.f, self.frame.size.height / 2.f);
}

- (CGFloat)heightWithPickerViewHeightType:(ECustomPickerViewHeightType)type {
